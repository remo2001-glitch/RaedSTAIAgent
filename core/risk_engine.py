...
DEFAULT_RISK_CONFIG = {
    ...
    "max_daily_loss":       0.03,   # عُدِّل: 5% → 3%     # 5٪ خسارة يومية قصوى
    "max_drawdown":         0.12,   # عُدِّل: 15% → 12%     # 15٪ حد أقصى للـ Drawdown
...
class RiskEngine:
    ...
    def status_report(self, portfolio: float) -> Dict:
        ...
        return {
            ...
            "daily_loss_used": round(abs(self._get_today_loss()) /
                                     (self.cfg["max_daily_loss"] * portfolio) * 100, 1),
        }
