    ...
    async def analyze_chart_image(self, image_data: bytes,
        ...
        try:
            ...
            prompt_text = (
                ...
                " الأقسام المطلوبة:"
                " 0-نوع السوق: اذكر صراحةً 'Futures/Perp' إذا رأيت أي من: كلمة Perp أو Swap أو Perpetual أو Mark Price أو Funding Rate أو Overnight في الشارت، وإلا اذكر 'Spot'"
                " 1-الاتجاه العام وقوته"
                " 2-مستويات الدعم والمقاومة بالأسعار الدقيقة"
                " 3-النماذج الفنية الظاهرة"
                " 4-تحليل الشموع الأخيرة"
                " 5-التوصية: شراء/بيع/انتظار مع توضيح هل هي Long أم Short في حالة Futures"
                " 6-نقطة الدخول المقترحة"
                " 7-وقف الخسارة"
                " 8-هدف الربح الأول والثاني مع نسبة R/R"
                " 9-مستوى المخاطرة (نسبة مئوية من رأس المال)"
                " 10-تحليل مؤشر KDJ إن كان ظاهراً (K/D/J وإشارات التشبع)"
                " 11-تحليل MACD (الهيستوجرام إيجابي أم سلبي، ومعناه)"
            )
            ctx  = ssl.create_default_context()
            loop = asyncio.get_event_loop()
