  ...
  "risk_flags": ["<خطر إن وجد>"]
    ...
    async def analyze_symbol(self, symbol: str,
        ...
        prompt = (
            ...
            "قدم: ١-الاتجاه الكبير (6-12 شهر) أولاً ثم القصير "
            "٢-الدعم والمقاومة الدقيقة ٣-توقعات أسبوع وشهر "
            "٤-توصية شراء/بيع/انتظار ٥-نقاط الدخول والخروج ٦-مستوى المخاطرة. "
            "SAR فوق السعر=هابط. SAR تحت السعر=صاعد. كن محدداً بالأسعار."
        )
    ...
    async def analyze_chart_image(self, image_data: bytes,
        ...
        try:
            ...
            prompt_text = (
                ...
                " الأقسام المطلوبة:"
                " ١-الاتجاه العام وقوته"
                " ٢-مستويات الدعم والمقاومة بالأسعار الدقيقة"
                " ٣-النماذج الفنية الظاهرة"
                " ٤-تحليل الشموع الأخيرة"
                " ٥-التوصية: شراء/بيع/انتظار"
                " ٦-نقطة الدخول المقترحة"
                " ٧-وقف الخسارة"
                " ٨-هدف الربح الأول والثاني"
                " ٩-مستوى المخاطرة (نسبة مئوية من رأس المال)"
            )
            ctx  = ssl.create_default_context()
            loop = asyncio.get_event_loop()
