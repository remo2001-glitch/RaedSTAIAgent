...
def _build_professional_block(
    ...
    # ADX فقط عند حد الخطورة (> 45) — تجنب التكرار مع regime_detector (#86/#130)
    if adx > 45:
...
async def cmd_analyze(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        try:
            ...
            # إصلاح #71/#126: إزالة سطور الهيدر المكررة من نص Groq
            analysis = _strip_header_duplicates(analysis)
