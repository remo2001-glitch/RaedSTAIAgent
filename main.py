...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "🤖 *رائد — Institutional Balanced Crypto AI Trading Agent*\n"
        "━━━━━━━━━━━━━━━━━━\n\n"
        "مرحباً! أنا رائد، وكيل تداول ذكي بمستوى صناديق التحوط.\n\n"
        "📊 *التحليل*\n"
        "/signal [رمز] — إشارة تداول شاملة\n"
        "/news [رمز] — تحليل أخبار السوق\n"
        "/regime [رمز] — حالة السوق الحالية\n"
        "/onchain — تحليل On-Chain\n"
        "/liquidity [رمز] — تحليل السيولة\n"
        "/backtest [رمز] [استراتيجية] — اختبار تاريخي\n\n"
        "📋 *التخطيط*\n"
        "/plan_month [عملات] — خطة شهرية\n"
        "/plan_week [عملات] — خطة أسبوعية\n"
        "/portfolio — توزيع المحفظة\n\n"
        "⚡ *التنفيذ*\n"
        "/autotrade on|off — تداول تلقائي\n"
        "/execute [رمز] [buy|sell] [مبلغ] — تنفيذ فوري\n\n"
        "📊 *المراقبة*\n"
...
async def post_init(app: Application):
    ...
    await app.bot.set_my_commands([
        ...
        BotCommand("plan_month",  "خطة شهرية"),
        BotCommand("plan_week",   "خطة أسبوعية"),
